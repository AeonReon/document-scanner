...
const VERSION = 'docscan-v7';
const PRECACHE = [
  '/',
  '/index.html',
  '/styles.css?v=7',
  '/manifest.json',
  '/images/favicon-32.png?v=7',
  '/images/apple-touch-icon.png?v=7',
  '/images/icon-192.png?v=7',
  '/images/icon-512.png?v=7',
  '/images/icon-maskable.png?v=7',
  '/js/util.js?v=7',
  '/js/imaging.js?v=7',
  '/js/pdf.js?v=7',
  '/js/db.js?v=7',
